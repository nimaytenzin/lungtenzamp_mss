...
@section('content')
    ...
    <div class="flex flex-wrap gap-4 p-4">
        ...
        @foreach ($classrooms as $item)
            <div class="bg-white rounded-md shadow-lg p-12 m-4 flex flex-col justify-center items-center">

                <div class="text-center">
                    <p class="text-5xl text-gray-700 text-green-400 font-thin mb-2">{{ $item->grade->name }}
                        {{ $item->section }}</p>
                    <p class="text-md text-gray-400 font-normal">Class Teacher:{{ $item->teacher->name }}</p>
                </div>
                <div class="flex gap-4 mt-4">
                    <button
                        class="mb-2 md:mb-0 bg-green-400 px-5 py-2 text-sm shadow-sm font-medium tracking-wider text-white rounded-full hover:shadow-lg hover:bg-indigo-500">
                        Enroll Students
                    </button>

                    <button
                    class="mb-2 md:mb-0 bg-indigo-400 px-5 py-2 text-sm shadow-sm font-medium tracking-wider text-white rounded-full hover:shadow-lg hover:bg-green-500">
